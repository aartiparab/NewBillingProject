...
{
    public partial class Damaged_Item_Screen : Form
    {
        ...
        public Damaged_Item_Screen(string username, string company, string connectionString)
        {
            InitializeComponent();
        ...
        private void Damaged_Item_Screen_Load(object sender, EventArgs e)
        {
                    ...
                    using (SqlConnection connection = new SqlConnection(connectionString))
                    {
                        ...
                        try
                        {
                            ...
                            for (int i = 0; i < Convert.ToInt32(dataGridView1.Rows.Count - 1); i++)
                            {
                                ...
                                command.Parameters.AddWithValue("@Status1", "Damaged");
