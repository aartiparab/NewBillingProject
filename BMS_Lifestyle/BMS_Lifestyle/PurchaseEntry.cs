...
namespace BMS_Lifestyle
{
    public partial class PurchaseEntry : Form
    {
        ...
        int sup_id, sum,m = 0;
        string T_BalQTY;
        public PurchaseEntry(string username, string company, string connectionString, string PONo1)
        {
            InitializeComponent();
        ...
        private void PurchaseEntry_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                con.Open();
                cmd = new SqlCommand("exec [Pending_PONo] '" + PONo1 + "'", con);
                ...
                if (dr.HasRows)
                {
                    while (dr.Read())
                    {
                        ...
                        dtpPO_Date.Text = dr["PO_Date"].ToString();
                        cmbSupName.Text = dr["SupName"].ToString();
                        ...
                        txttotqty.Text = dr["TQty"].ToString();
                        T_BalQTY = dr["Tbal_qty"].ToString();
                ...
                cmd = new SqlCommand("exec [Pending_PoNo_Sub] '" + PONo1 + "'", con);
                //cmd.CommandType = CommandType.Text;
                dr = cmd.ExecuteReader();
                if (dr.HasRows)
                {
                    while (dr.Read())
                    {
                        ...
                        dataGridView1.Rows[count].Cells["barcode1"].Value = dr["EAC_Code"].ToString();
                        dataGridView1.Rows[count].Cells["Column1"].Value = dr["P_Name"].ToString();
                        dataGridView1.Rows[count].Cells["group"].Value = dr["Groups"].ToString();
                        dataGridView1.Rows[count].Cells["unit"].Value = dr["unit1"].ToString();
                        dataGridView1.Rows[count].Cells["qty1"].Value = "0";
                        dataGridView1.Rows[count].Cells["Po_Qty"].Value = dr["PO_QTY"].ToString();
                        dataGridView1.Rows[count].Cells["bal_po_qty"].Value = dr["Bal_Qty"].ToString();
                        dataGridView1.Rows[count].Cells["rate1"].Value = dr["Rate"].ToString();
                        dataGridView1.Rows[count].Cells["disc"].Value = "0";
                        dataGridView1.Rows[count].Cells["disc_amt"].Value = "0";
                        ...
                        dataGridView1.Rows[count].Cells["cgstper1"].Value = dr["cgsttax"].ToString();
                        dataGridView1.Rows[count].Cells["sgstper1"].Value = dr["sgsttax"].ToString();
                        dataGridView1.Rows[count].Cells["igstper1"].Value = dr["igsttax"].ToString();
                        dataGridView1.Rows[count].Cells["cgstamt1"].Value = dr["cgstamt"].ToString();
                        dataGridView1.Rows[count].Cells["sgstamt1"].Value = dr["sgstamt"].ToString();
                        dataGridView1.Rows[count].Cells["igstamt1"].Value = dr["igstamt"].ToString();
